...
/**
 * CURRICULUM MATRIX v4.0 (PRODUCTION GRADE)
 * 
 * CHANGES VS V3:
 * - Added 'prerequisite_ids': Defines the dependency graph (DAG).
 * - Added 'Wiskunde B' (Calculus) and 'Economie' (Markets) modules.
 * - Granularity increased: Topics are broken down into 45-60min study blocks.
 * - 'common_misconceptions' are now specific diagnostic triggers.
 */

export const CURRICULUM_PATHS: LearningPath[] = [
    // =================================================================================
    // WISKUNDE B (VWO) - DOMEIN C: DIFFERENTIAALREKENING
    // Een strikt hiërarchische leerlijn waar stap N niet kan zonder stap N-1.
    // =================================================================================
    {
        subject: 'Wiskunde B',
        level: 'VWO',
    ...
    // =================================================================================
    // ECONOMIE (HAVO) - DOMEIN D: MARKT (VRAAG & AANBOD)
    // Focus op grafisch inzicht, rekenvaardigheid en logisch redeneren.
    // =================================================================================
    {
        subject: 'Economie',
        level: 'HAVO',
    ...
    // =================================================================================
    // BIOLOGIE (VWO) - DOMEIN B: MOLECULAIRE GENETICA (EXPANDED)
    // Diepgaande biochemische processen.
    // =================================================================================
    {
        subject: 'Biologie',
        level: 'VWO',
...
// Helper functies voor de frontend/backend logica
