...
const Dashboard: React.FC<DashboardProps> = ({ analysis, mechanical, isOpen, onClose, theme, isLoading = false, profile, eaiState, onEditProfile }) => {
  ...
  // Determine current node from "where we think we are". 
  // In a real app this state should be passed explicitly. 
  // For now, we visualize based on what's available. 
  // We assume the service handles the index, but here we show the map.
