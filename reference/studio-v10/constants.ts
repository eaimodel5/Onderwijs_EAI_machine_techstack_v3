...
// SSOT is now loaded from ssot.ts via utils/ssotParser.ts
...
Stap 2: Validate (Logische consistentie check o.b.v. Logic Gates).
...
JE BESCHIKT OVER EEN GEINJECTEERDE CONTEXT (RUBRICS + COMMANDS + GATES).
GEBRUIK DEZE DATA STRIKT. VERZIN GEEN EIGEN REGELS.
...
3. Kies EEN strategie uit de rubrics die de leerling een stap verder helpt.
4. COMMAND EXECUTION: Als input start met '/' commando, zoek de definitie in 'command_library' en voer uit.
...
export const AVAILABLE_MODELS = [
  { id: GeminiModel.FLASH, name: 'Flash (Fast)' },
  { id: GeminiModel.PRO, name: 'Pro (Reasoning)' }
];

export const DEFAULT_SYSTEM_INSTRUCTION = "Je bent een behulpzame AI leercoach.";