...
const BootSequence: React.FC<BootSequenceProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#0f172a] flex flex-col items-center justify-center transition-opacity duration-1000 ease-in-out cursor-wait" style={{ opacity: opacity / 100 }}>
        <div className="relative flex flex-col items-center">
            ...
            <div className="mt-8 text-center space-y-2">
                ...
                <p className="text-[10px] text-slate-500 font-medium tracking-[0.3em] uppercase animate-pulse">Initializing</p>
            </div>
        </div>
        <div className="absolute bottom-8 text-[9px] text-slate-600 font-mono">v9.0</div>
    </div>
  );
};
