...
export function buildPastePromptText(
  context: CardContext,
  bands: BandSelection,
  policy: Policy,
  outputContract: any,
  ...
  lines.push("Als je twijfelt of informatie klopt, vraag door en stel een verificatiestap voor.");
  lines.push("Geef geen eindantwoord als dat verboden is door de regels hierboven.");
